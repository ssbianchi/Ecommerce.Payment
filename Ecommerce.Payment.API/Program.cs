...
using Ecommerce.Payment.API.Filter;
using Microsoft.OpenApi.Models;
using System.Text.Json.Serialization;
using Ecommerce.Payment.Repository;
using Ecommerce.Payment.Application;
using Ecommerce.Payment.CrossCutting;
using Ecommerce.Payment.API.Filter;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        ...
        Description = "An ASP.NET Core Web API to acess diverse services of the Ecommerce Payment.",
...
builder.Services.RegisterRepository(builderConfig["EcommercePaymentDatabase"]);
